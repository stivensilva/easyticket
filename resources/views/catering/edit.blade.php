...
@section('content')
  ...
  <div>
    ...
    <h4 class="fw-bold py-3 mb-2">Edit catering</h4>
  </div>
  ...
  <div class="row">
    <div class="col-xl">
      <div class="card mb-4">
        <div class="card-body">
        <form action="{{ url('catering/'.$data->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="row">
              ...
              <div class="mb-3 col-md-1">
                <a href="{{ url('images/catering/'.$data->image) }}" data-lightbox="{{ $data->name }}" data-title="{{ $data->name }}">
                  <img src="{{ url('images/catering/'.$data->image) }}" alt="" style="height: 80px; width:80px; border: 1px solid #d9dee3; padding: 2px; border-radius: 10px;">
                </a>
              </div>
