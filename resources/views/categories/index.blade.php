...
@section('content')
  ...
  <div>
    <a href="{{ url('categories/create') }}" class="btn btn-primary float-end"><i class="bx bx-plus"></i>New</a>
      ...
      <table class="table table-hover">
        ...
        @foreach($data as $category)
          <tr>
            ...
            <td>
              <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                <li
                  ...
                  title="{{ $category->name }}"
                >
                <a href="{{ url('images/categories/'.$category->image) }}" data-lightbox="{{ $category->name }}" data-title="{{ $category->name }}">
                  <img src="{{ url('images/categories/'.$category->image) }}" alt="Avatar" class="rounded" />
                </a>
                </li>
              </ul>
            </td>
            ...
            <td>
              <a href="{{ url('categories/'.$category->id.'/edit') }}" class="btn btn-outline-dark btn-sm" title="Edit category">
